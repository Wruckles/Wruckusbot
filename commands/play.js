  ...
  run: async function (client, message, args) {
   ...
   var serverQueue = message.client.queue.get(message.guild.id);
    ...
    if (serverQueue) {
      ...
      .setAuthor("Song has been added to queue", "https://raw.githubusercontent.com/Wruckles/Wruckusbot/main/assets/mangekyo%20sharingan.gif?token=ASP7LYGZSURDO7327AXAISLAAX3IY")
